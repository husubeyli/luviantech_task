    ...
    $("#register").click(function(e){
        ...
        request.done(function (data) {
            if (data["success"] == true) {
                ...
                let register_content = document.getElementById('register_box')
                let otp_content = document.getElementById('otp_box')
                register_content.classList.add('d-none')
                otp_content.classList.remove('d-none')
    ...
    $("#login").click(function(e){
        ...
        request.done(function (data) {
            ...
            if (data["success"] == true) {
                ...
                $.cookie('refresh_token', refresh_token, { expires: cookie_expire_time });
                $.cookie('username', username, { expires: cookie_expire_time });
                // console.log($.cookie('access_token'), 'baxaq');
                // debugger
                $(location).attr('href', '/e_commerce/');
            } else {
                Swal.fire(data["error"])
